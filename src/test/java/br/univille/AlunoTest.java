...
public class AlunoTest {
    ...
    public void testaAlunoCDF(){
        ...
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 1", 10f));
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 2", 10f));
    ...
    public void testaAlunoEsforcado(){
        ...
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 1", 6f));
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 2", 7f));
        assertAll(
    ...
    public void testaAlunoTurista(){
        ...
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 1", 2f));
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 2", 2f));
        assertAll(
            () -> assertEquals(false, alunoTeste.estaAprovado()),
            () -> assertEquals(false, alunoTeste.estaEmExame()),
    ...
    public void testaAluno(){
        alunoTeste.setPercFrequencia(67);
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 1", 10f));
        alunoTeste.getListaDeNotas().add(new Avaliacao("Nota 2", 1f));
        assertAll(
            () -> assertEquals(false, alunoTeste.estaAprovado()),
            () -> assertEquals(false, alunoTeste.estaEmExame()),
            () -> assertEquals(true, alunoTeste.estaReprovado())
